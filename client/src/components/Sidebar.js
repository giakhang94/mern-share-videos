...
function SideBar() {
  ...
  if (state.isAdmin) {
    return (
      <div className="sidebar  border-l-[#AB7A5F] border-l-[3px] ml-[1px] bg-white -mt-5 pt-10 px-10 space-y-5 shadow-sm shadow-gray-500 h-screen min-h-full laptop:block tablet:hidden Pmobile:hidden Psmallmobile:hidden mobile-hidden  smallmobile:hidden mobile:hidden  Ptablet:block Ptablet:max-w-[250px] laptop:max-w-[500px]">
        <NavLink
